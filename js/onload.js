...
--------------------------*/
  var Ajax_v5 = {
    ...
    init_from_function: function (books_) {
      $("body").append(
        "<div id='fb5-ajax' class='fb5-fullbrowser fb5-lightbox'><div class='fb5-bcg-book'></div><div class='fb5-preloader'></div></div>"
      );
    ...
    isPdf_js: function () {
      if (
        Book_v5.getConfig("pdf_type") == "js" &&
        Book_v5.getConfig("pdfjs_source").length > 0
      ) {
        return true;
      } else {
        return false;
...
--------------------------*/
  ...
  youtube = function (id_, w_, h_) {
    ...
    $("body").prepend(
      '<div id="v5_lightbox"><div class="bcg"></div><iframe class="youtube-player youtube_lightbox" width=' +
        w +
        " height=" +
        h +
...
--------------------------*/
  var Book_v5 = {
    ...
    ready: function () {
      ...
      IS_AS_TEMPLATE =
        $("#fb5-ajax").attr("data-template") == "true" ? true : false;
      ...
      if (
        Book_v5.getConfig("lazy_loading_thumbs") != "true" &&
        Book_v5.getConfig("pdf_type") != "js"
      ) {
      ...
      if (Book_v5.getConfig("pdf_type") != "js") {
        if (Book_v5.getConfig("lazy_loading_pages") == "true") {
          ...
          var results = $(
            "#fb5-deeplinking ul li[data-address=" + address + "]"
          );
      ...
      if (Book_v5.getConfig("pdf_type") == "js") {
        ...
        for (var i = 1; i <= _pdf_length; i++) {
          ...
          var page =
            '<div data-background-image=""><div class="fb5-cont-page-book"><div id="canv' +
            i +
            '" class="pdfjs"><div class="canvas"></div><div class="annotation"></div></div><div class="fb5-gradient-page"></div><div class="fb5-page-book"></div></div><div class="links">' +
            links +
            "</div></div>";
          ...
          var dep =
            '<li data-address="' + address + '" data-page="' + i + '"></li>';
      ...
      if (DISPLAY == "single") {
        $("#fb5 .fb5-page-book").css(
          "width",
          WIDTH_BOOK - (paddingL + paddingR) + "px"
        );
      } else {
        $("#fb5 .fb5-page-book").css(
          "width",
          ...
          if (e.originalEvent.touches.length == 1) {
            ...
            if (deltaTime < 300 && _this._click >= 2) {
              ...
              if (Book_v5.checkScrollBook() == false) {
                ...
                Book_v5.setPointZoom(
                  _this.book_x - container_book.left,
                  _this.book_y - container_book.top
                );
    ...
    renderPage: function (num) {
      ...
      //create canvas
      if ($(".canvas", pdfjs).children().length == 0) {
        //if not have canvas
      ...
      $("#fb5-book").turn({
        ...
        when: {
          ...
          turned: function (e, page) {
            ...
            // Added by Alex for tracking.
            var evt = new CustomEvent("onPageTurned", { detail: page });
            ...
            if (
              Book_v5.getConfig("lazy_loading_pages") == "true" ||
              Ajax_v5.isPdf_js()
            ) {
    ...
    book_area: function (w_, h_, tools_) {
      ...
      if (
        ...
        $("#fb5-ajax").hasClass("fb5-fullbrowser") ||
        $("#fb5-ajax").hasClass("fullScreen")
      ) {
        //var height=$(window).height()+"px";
    ...
    resize_page: function () {
      ...
      $("#fb5 .odd.turn-page .fb5-page-book").css({
        left: paddingL + "px",
        top: paddingT + "px",
      });
      $("#fb5 .even.turn-page .fb5-page-book").css({
        left: paddingR + "px",
        top: paddingT + "px",
      });
